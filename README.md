...
| Name                                                                         | Description                                                                                        | Port | Dynamic (39) |
| ---------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ---- | ------------ |
...
| [FileBrowser Quantum](https://github.com/gtsteffaniak/filebrowser)           | FileBrowser Quantum is a web-based file manager and browser.                                       | 8837 | yes          |
